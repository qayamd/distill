    ...
    def __init__(
        ...
        for name, param in self.model.named_parameters():
            ...
            if param.requires_grad:
                ...
                if ("q_proj.weight" in name or "wq.weight" in name or "peer.attention.in_proj_weight" in name):
                    count_q += 1
                ...
                if ("k_proj.weight" in name or "wk.weight" in name or "peer.attention.in_proj_weight" in name):
                    count_k += 1
        ...
        if count_embd == 0:
            print("=====>>> Warning by Adam-mini: No embedding layer found. If you are training Transformers, please check the name of your embedding layer and manually add them to 'self.embd_blocks' of Adam-mini.")
        if count_output == 0:
            print("=====>>> Warning by Adam-mini: No output layer found.  If you are training Transformers (without weight-tying), please check the name of your output layer and manually add them to 'self.embd_blocks' of Adam-mini. Please ignore this warning if you are using weight-tying.")
        if count_q == 0:
            print("=====>>>  Warning by Adam-mini: No Query found.  If you are training Transformers, please check the name of your Query in attention blocks and manually add them to 'self.qk_blocks' of Adam-mini")
        if count_k == 0:
            print("=====>>>  Warning by Adam-mini: No Key found.  If you are training Transformers, please check the name of your Key in attention blocks and manually add them to 'self.qk_blocks' of Adam-mini")
